            ...
            <div class="card shadow rounded-0">
                ...
                <div class="card-body py-4">
                    <div class="container-fluid">
                        ...
                        ?>
                        <form action="/Medcancer/login/login.php" method="POST">
                            ...
                            <div class="form-group text-cneter">
                                <a href="/Medcancer/login/registration.php">Create a New Account</a>
                            </div>
                            <div class="form-group text-cneter">
                                <a href="/Medcancer/login/forgot.php">reset password</a>
                            </div>
                        </form>
                    </div>
                </div>
